...
const pre_read_truncate_op = new TruncateNewsOperator().mapInput("truncate_input_items", "deduped_items")
    .mapOutput("truncated_items", "pre_read_truncated_items")
    .mapOptions("truncate_max_items_per_category", "pre_read_truncate_number")
    .setName("pre_read_truncate_news");
// In: deduped_items Out: pre_read_truncated_items
...
// In: post_summarize_truncated_items Out: news_text

const send_news_op = new SendNewsOperator(); // In: news_text, channels Out: sent

const save_news_op = new SaveNewsOperator().mapInput("save_input_items", "post_summarize_truncated_items");
